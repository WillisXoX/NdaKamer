      ...
      <div class="contain">
        <div class="container" id="container">
        	<div class="form-container sign-up-container">
        		<form action="signUpRegister.php" class="formSignUp" id="formRegister" method="post">
            <?php if(!empty($msg1)){
                echo $msg1;
              } ?>
        			<h1>Create Account</h1>
        			<span>ou utilise ton compte bailleur pour t'enregistrer</span>
        	...
        	<div class="form-container sign-in-container">
        		<form action="signUpUser.php" class="formSignUp" id="formUser" method="post">
              <?php if(!empty($msg2)){
                  echo $msg2;
                } ?>
        			<h1>Sign in</h1>
        			<span>ou utilse ton compte bailleur</span>
