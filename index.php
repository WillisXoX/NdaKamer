    ...
    <div class="main-block">
      ...
      <header class="nav-block">
        ...
        <nav class="link-block">
          <ul>
            <li><a href="index.php" class="link active">ACCUIEL</a></li>
            <li><a href="index.php#logement" class="link">LOGEMENTS</a></li>
            <li><a href="agent.php#logement" class="link">AGENTS</a></li>
            <li><a href="signUp.php" class="link-btn">BAILLEUR</a></li>
            <li><a href="signUpPage.php" class="link-btn">AGENT</a></li>
          </ul>
        </nav>
      </header>
      ...
      <div class="search-container">
        <div class="wrapper">
          ...
          <div class="form__title">
            ...
            <p>Recherchez vos logement de manieres facile et precise.</p>
          </div>

          <div class="search-input">
            <div class="search">
              <form class="" action="index.php#logement" method="post">
